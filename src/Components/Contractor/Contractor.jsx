...
import ContractorAnimation from "../../Images/ContractorAnimation.json";
    ...
    <>
      <div className="my-[100px]  w-[90%] mx-auto pt-[50px]">
        <div className="mt-[20px] mb-[30px] flex items-center justify-around flex-col md:flex-row">
          ...
          >
            <h1 className="mb-4 relative after:absolute after:content-[''] after:w-[100px] after:h-[4px] after:rounded-full after:bg-[--main-color] after:left-0 after:top-[-10px] text-3xl text-[--main-color] font-bold">
              Contractor's Projects
            </h1>
            <p className="mb-6 text-[20px] leading-[1.8] capitalize">
              Here you can explore all the projects completed by the contractor.
              Feel free to browse through and get inspired for your upcoming
              work.
            </p>
          </motion.div>
          <motion.div
        ...
        <div>
          ...
          >
            <input
              type="submit"
              value="Send"
              className="rounded-xl px-5 py-1 mt-[30px] font-bold border border-[--main-color] text-[25px] text-[--main-color] transition-all hover:text-white hover:scale-[1.2] cursor-pointer hover:bg-[--main-color]"
            />
          </motion.div>
        </div>
      </div>
